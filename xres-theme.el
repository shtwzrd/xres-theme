...
(defgroup xres-theme nil
  "Xres-theme options."
  :group 'faces)

(defcustom xres-theme-comment-bg nil
...
(defcustom xres-theme-org-height t
  "Use varying text heights for org headings."
  :type 'boolean
  :group 'xres-theme)

(defun xres-color (name)
  "Query xrdb for color NAME (green, brightwhite, background, etc)"
  (let ((query (concat "xrdb -query | grep '" (cdr (assoc name color-to-index)) "'")))
    (if (and (equal name "background") (not (display-graphic-p)))
        "unspecified-bg"
     (nth 1
...
(defun create-xres-theme (variant theme-name)
  (let ((class '((class color) (min-colors 16)))
        ...
        (bg3             (xres-color "brightblack")  )
        (bg4             (xres-color "black")        )
        (key1            (xres-color "cyan")         )
        (key2            (xres-color "brightcyan")   )
        (builtin         (xres-color "brightblue")   )
        (keyword         (xres-color "brightblue")   )
        (const           (xres-color "magenta")      )
        (comment         (xres-color "green")        )
        (comment-bg      (xres-color "background")   )
        (func            (xres-color "magenta")      )
        (str             (xres-color "brightgreen")  )
        (type            (xres-color "cyan")         )
        (comp            (xres-color "brightmagenta"))
        (var             (xres-color "white")        )
        (err             (xres-color "brightred")    )
        (war             (xres-color "yellow")       )
        (inf             (xres-color "brightblue")   )
        (suc             (xres-color "brightgreen")  )
        (green           (xres-color "green")        )
        (yellow          (xres-color "yellow")       )
        (cyan            (xres-color "cyan")         )
        (violet          (xres-color "magenta")      )
        (red             (xres-color "red")          )
        (active1         (xres-color "black")        )
        (active2         (xres-color "brightblack")  )
        (inactive        (xres-color "black")        )
        (m-line-brdr     (xres-color "black")        )
        (org-block-bg    (xres-color "background")   )
        (org-h1-bg       (xres-color "black")        )
        (org-h2-bg       (xres-color "background")   )
        (org-h3-bg       (xres-color "background")   )
        (org-h4-bg       (xres-color "background")   )
        (highlight       (xres-color "brightblack")  ))
...
;;;;; basics
     ...
     `(font-lock-comment-face ((,class (:foreground ,comment :background ,(when xres-theme-comment-bg comment-bg)))))
...
;;;;; org
     ...
     `(org-document-title ((,class (:foreground ,func :weight bold :height ,(if xres-theme-org-height 1.4 1.0) :underline t))))
     `(org-done ((,class (:foreground ,(if (eq variant 'dark) suc green) :bold t :overline t :background ,org-h3-bg))))
     `(org-ellipsis ((,class (:foreground ,builtin))))
     `(org-footnote  ((,class (:underline t :foreground ,base))))
     `(org-hide ((,class (:foreground ,base))))
     `(org-level-1 ((,class (:bold t :foreground ,inf :height ,(if xres-theme-org-height 1.3 1.0) :background ,org-h1-bg :overline t))))
     `(org-level-2 ((,class (:bold t :foreground ,str :height ,(if xres-theme-org-height 1.2 1.0) :background ,org-h2-bg))))
     `(org-level-3 ((,class (:bold nil :foreground ,green :height ,(if xres-theme-org-height 1.1 1.0) :background ,org-h3-bg))))
...
(deftheme xres "Theme from your Xresources")
(create-xres-theme 'dark 'xres)
(provide-theme 'xres)
